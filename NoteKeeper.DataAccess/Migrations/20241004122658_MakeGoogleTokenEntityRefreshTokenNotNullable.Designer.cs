...
namespace NoteKeeper.DataAccess.Migrations
{
    ...
    [Migration("20241004122658_MakeGoogleTokenEntityRefreshTokenNotNullable")]
    partial class MakeGoogleTokenEntityRefreshTokenNotNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NoteKeeper.DataAccess.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 10, 4, 12, 26, 57, 620, DateTimeKind.Utc).AddTicks(8580),
                            Email = "sepfrd@outlook.com",
                            PasswordHash = "$2a$12$RcIf3WgA.K4RaB3xda0vgezs870kB2lUfelrlY0EkQMC8vSSkS/Dq",
                            UpdatedAt = new DateTime(2024, 10, 4, 12, 26, 57, 620, DateTimeKind.Utc).AddTicks(8580),
                            Username = "sepehr_frd",
                            Uuid = new Guid("983e7806-73d9-48a3-b9bc-b3108c585987")
                        });
                });
