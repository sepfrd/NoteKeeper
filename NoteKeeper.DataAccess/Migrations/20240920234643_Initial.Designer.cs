...
namespace NoteKeeper.DataAccess.Migrations
{
    ...
    [Migration("20240920234643_Initial")]
            ...
            modelBuilder.Entity("NoteKeeper.DataAccess.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2024, 9, 20, 23, 46, 42, 779, DateTimeKind.Utc).AddTicks(6650),
                            Email = "sepfrd@outlook.com",
                            PasswordHash = "$2a$12$9FpbeHCX6SZA5DcxY4DMQu9V46tH9gVU0ZZTAu.Jyg/YunXt3ibT.",
                            UpdatedAt = new DateTime(2024, 9, 20, 23, 46, 42, 779, DateTimeKind.Utc).AddTicks(6650),
                            Username = "sepehr_frd"
                        });
                });
