...
public static class ConfigurationConstants
{
    ...
    public const string GoogleOAuth2ConfigurationSectionKey = "GoogleOAuth2Configuration";
    public const string NotionOAuth2ConfigurationSectionKey = "NotionOAuth2Configuration";
}